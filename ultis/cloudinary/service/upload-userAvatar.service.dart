...
abstract class IUploadUserAvatarService {
  Future<String?> uploadUserAvatar(String avatarUserPath);

  Future<String?> uploadFile(String filePath, String folder);
}

class UploadUserAvatarService implements IUploadUserAvatarService {
  ...
  @override
  Future<String?> uploadUserAvatar(String avatarUserPath) async {
    final url = await uploadFile(avatarUserPath, 'avatarUser');
    return url;
  }
